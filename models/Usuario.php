<?php
    class Usuario extends Conectar{
        ...
        public function insert_usuario($usu_nom,$usu_ape,$usu_correo,$usu_pass,$rol_id,$usu_telf){
            ...
            parent::set_names();
            /*Consulta SQL*/
            $sql="INSERT INTO tm_usuario (usu_id,usu_nom,usu_ape,usu_correo,usu_pass,rol_id,usu_telf,fecha_creac,fecha_modif,fecha_elim,estado) VALUES (NULL,?,?,?,MD5(?),?,?,now(), NULL, NULL, '1');";
        ...
        public function lupdate_usuario_pass($usu_id,$usu_pass){
            $conectar = parent::conexion();
            parent::set_names();
            /*Consulta SQL*/
            $sql="UPDATE tm_usuario
        ...
        public function get_correo_usuario($usu_correo){
            ...
            parent::set_names();
            /*Consulta SQL*/
            $sql="SELECT * FROM tm_usuario WHERE usu_correo=? AND estado=1;";
            $sql=$conectar->prepare($sql);
