...
<html>
    ...
    <title>Gerlashin - Nuevo Ticket</title>
</head>
			...
			<div class="box-typical box-typical-padding">
				...
				<div class="row">
					<form method="post" id="ticket_form">
						...
						<div class="col-lg-6">
							<fieldset class="form-group">
								<label class="form-label semibold" for="subcat_id">Subcategoria</label>
						...
						<div class="col-lg-6">
							<fieldset class="form-group">
								<label class="form-label semibold" for="priori_id">Prioridad</label>
								<select id="priori_id" name="priori_id" class="form-control">
