...
function editar(subcat_id){
    $('#mdltitulo').html('Editar Registro');

    $.post("../../controller/subcategoria.php?op=mostrar", {subcat_id: subcat_id}, function(data){
        data = JSON.parse(data);
        $('#subcat_id').val(data.subcat_id);
...
function eliminar(subcat_id){
    ...
    function(isConfirm) {
        if (isConfirm) {
            $.post("../../controller/subcategoria.php?op=eliminar", {subcat_id: subcat_id}, function(data){
            ...
            swal({
                ...
                text: "La subcategoria se ha eliminado!",
                type: "success",
                confirmButtonClass: "btn-success"
            });
        } 
